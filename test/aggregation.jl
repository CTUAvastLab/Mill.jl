...
@testset "aggregation functionality" begin
	...
	@test segmented_meanmax(x2, bags2) ≈ vcat(segmented_max(x2, bags2), segmented_mean(x2, bags2))
	...
	@test segmented_weighted_meanmax(x2, bags2, w) ≈ vcat(segmented_weighted_max(x2, bags2, w), segmented_weighted_mean(x2, bags2, w))
end

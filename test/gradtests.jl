...
let
    ...
    @testset "model aggregation grad check w.r.t. inputs" begin
        ...
        y = randn(3, 4)
        z = randn(2, 8)
        bags = AlignedBags([1:2, 3:4, 0:-1])
        bags2 = AlignedBags([1:1, 0:-1, 2:4])
        bags3 = AlignedBags([1:1, 2:2, 3:6, 0:-1, 0:-1, 7:8])
    ...
    @testset "model aggregation grad check w.r.t. inputs weighted" begin
        ...
        w2 = abs.(randn(4)) .+ 0.01
        w3 = abs.(randn(8)) .+ 0.01
        bags = AlignedBags([0:-1, 0:-1, 1:2, 3:4])
        bags2 = AlignedBags([1:1, 2:4, 0:-1, 0:-1])
        bags3 = AlignedBags([1:1, 2:2, 0:-1, 3:6, 7:8, 0:-1])
    ...
    @testset "model aggregation grad check w.r.t. params" begin
        ...
        y = randn(3, 4)
        z = randn(2, 8)
        bags = AlignedBags([0:-1, 1:2, 3:4])
        bags2 = AlignedBags([1:1, 0:-1, 2:4])
        bags3 = AlignedBags([1:1, 2:2, 0:-1, 0:-1, 3:6, 7:8])

...
_mean_grad(x::Matrix, c::Vector, bags, w::Union{Vector, Nothing}) = segmented_mean(x, c, bags, w)
_mean_grad(x::Matrix, c::Vector, bags, w::Union{Vector, Nothing}, mask::Union{Vector, Nothing}) = segmented_mean(x, c, bags, w, mask)
